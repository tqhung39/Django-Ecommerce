    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect("https://pay.stripe.com/receipts/acct_1Eri99GrA3QmcRSL/ch_1EwluPGrA3QmcRSLMUJNNBhg/rcpt_FRfER76aqAlLV77vJ65n3ulNaEmUnXk")
...
def searchbook(request):
    if request.method == 'GET':
        ...
        if query is not None:
            lookups = Q(title__icontains=query) | Q(slug__icontains=query)
